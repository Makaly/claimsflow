...
const DEMO_CLAIMS: ClaimRow[] = [
  ...
  { id: 'c3', claimNumber: 'CLM-2026-0035', patientName: 'Carol Wanjiku', memberNumber: 'MEM-9012', invoiceNumber: 'INV-003', invoiceAmount: 31000, status: 'under_review', workflowStage: 'checker_review', priority: 'urgent', submittedAt: new Date(Date.now() - 259200000).toISOString(), branchName: 'Nairobi West Branch' },
