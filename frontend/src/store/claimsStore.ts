...
const initialClaims: ClaimRecord[] = [
  ...
  { id: '2', barcode: 'C2026040914000002', claimNumber: 'CLM-2026-00141', memberNumber: 'MBR-001235', memberName: 'Mary Wanjiku', patientName: 'Mary Wanjiku', provider: { name: 'Aga Khan University Hospital' }, invoiceAmount: 78000, status: 'under_review', workflowStage: 'maker_review', priority: 'high', ocrStatus: 'completed', submittedAt: '2026-04-09T14:00:00Z', documents: [{ name: 'invoice_wanjiku.pdf', size: 180000, type: 'application/pdf' }, { name: 'lab_results.pdf', size: 420000, type: 'application/pdf' }] },
