...
async function main() {
  ...
  // PR1 — mark every seeded user as email-verified so dev/demo accounts
  // can log in without going through the OTP flow. Real users created via
  // the registration form start unverified and must verify via OTP.
